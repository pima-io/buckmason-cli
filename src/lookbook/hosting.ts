...
const OPTIONS: HostingOption[] = [
  {
    ...
    rank: 1,
    best_for: 'Durable public-by-link lookbooks, default voting, Pages Functions, Durable Objects, and optional custom domains.',
    ...
    cautions: 'Public-by-URL. Voting uses a per-lookbook Durable Object; LOOKBOOK_VOTES KV is bound only for legacy ballot import. Do not run wrangler login inside the lookbook flow.',
  },
  {
    id: 'vercel',
    name: 'Vercel',
